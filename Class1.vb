...
'This Beautiful TabControl Comes from  : https://stackoverflow.com/questions/20802731/vb-net-custom-tab-controls
'I do not take any credits for this code !!! | Arsium
Public Class SmoothTabControl
    Inherits TabControl
    Sub New()
        SetStyle(ControlStyles.UserPaint Or ControlStyles.OptimizedDoubleBuffer Or ControlStyles.AllPaintingInWmPaint Or ControlStyles.SupportsTransparentBackColor Or ControlStyles.ResizeRedraw Or ControlStyles.DoubleBuffer, True)
        DoubleBuffered = True
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        ControlPaint.DrawBorder(e.Graphics, Me.ClientRectangle, ColorTranslator.FromHtml("#33ccff"), ButtonBorderStyle.Solid)
        G.Dispose() : B.Dispose()
    End Sub
End Class
